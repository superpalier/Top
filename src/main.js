...
const t_api = (msg) => {
  ...
  return mapping[norm] || mapping[msg] || msg;
};

const defaultContexts = [
  { id: 'entertainment', titles: { en: 'Entertainment', es: 'Entretenimiento', fr: 'Divertissement', de: 'Unterhaltung' }, icon: 'ph-popcorn', parentId: null, imageUrl: '/assets/categories/entertainment.png' },
  { id: 'music', titles: { en: 'Music', es: 'Música', fr: 'Musique', de: 'Musik' }, icon: 'ph-music-notes', parentId: 'entertainment', imageUrl: '/assets/categories/music.png' },
  { id: 'rock', titles: { en: 'Rock', es: 'Rock', fr: 'Rock', de: 'Rock' }, icon: 'ph-guitar', parentId: 'music', imageUrl: '/assets/categories/rock.png' },
  { id: 'classic_rock', titles: { en: 'Classic Rock', es: 'Rock Clásico', fr: 'Rock Classique', de: 'Classic Rock' }, icon: 'ph-vinyl', parentId: 'rock', imageUrl: '/assets/categories/classic_rock.png' },
  { id: 'indie_rock', titles: { en: 'Indie Rock', es: 'Rock Indie', fr: 'Rock Indie', de: 'Indie Rock' }, icon: 'ph-guitar', parentId: 'rock', imageUrl: '/assets/categories/indie_rock.png' },
  { id: 'metal', titles: { en: 'Metal', es: 'Metal', fr: 'Metal', de: 'Metal' }, icon: 'ph-skull', parentId: 'rock', imageUrl: '/assets/categories/metal.png' },
  { id: 'electronic', titles: { en: 'Electronic', es: 'Electrónica', fr: 'Électronique', de: 'Elektronik' }, icon: 'ph-speaker-hifi', parentId: 'music', imageUrl: '/assets/categories/electronic.png' },
  { id: 'techno', titles: { en: 'Techno', es: 'Techno', fr: 'Techno', de: 'Techno' }, icon: 'ph-vinyl', parentId: 'electronic', imageUrl: '/assets/categories/techno.png' },
  { id: 'house', titles: { en: 'House', es: 'House', fr: 'House', de: 'House' }, icon: 'ph-waves', parentId: 'electronic', imageUrl: '/assets/categories/house.png' },
  { id: 'synthwave', titles: { en: 'Synthwave', es: 'Synthwave', fr: 'Synthwave', de: 'Synthwave' }, icon: 'ph-sun-horizon', parentId: 'electronic', imageUrl: '/assets/categories/synthwave.png' },
  { id: 'pop', titles: { en: 'Pop', es: 'Pop', fr: 'Pop', de: 'Pop' }, icon: 'ph-star', parentId: 'music', imageUrl: '/assets/categories/pop.png' },
  { id: 'jazz', titles: { en: 'Jazz', es: 'Jazz', fr: 'Jazz', de: 'Jazz' }, icon: 'ph-trumpet', parentId: 'music', imageUrl: '/assets/categories/jazz.png' },
  { id: 'hiphop', titles: { en: 'Hip Hop', es: 'Hip Hop', fr: 'Hip Hop', de: 'Hip Hop' }, icon: 'ph-microphone-stage', parentId: 'music', imageUrl: '/assets/categories/hiphop.png' },
  { id: 'cinema', titles: { en: 'Cinema', es: 'Cine', fr: 'Cinéma', de: 'Kino' }, icon: 'ph-film-strip', parentId: 'entertainment', imageUrl: '/assets/categories/cinema.png' },
  { id: 'scifi', titles: { en: 'Sci-Fi', es: 'Ciencia Ficción', fr: 'Sci-Fi', de: 'Sci-Fi' }, icon: 'ph-rocket-launch', parentId: 'cinema', imageUrl: '/assets/categories/scifi.png' },
  { id: 'horror', titles: { en: 'Horror', es: 'Terror', fr: 'Horreur', de: 'Horror' }, icon: 'ph-skull', parentId: 'cinema', imageUrl: '/assets/categories/horror.png' },
  { id: 'animation', titles: { en: 'Animation', es: 'Animación', fr: 'Animation', de: 'Animation' }, icon: 'ph-palette', parentId: 'cinema', imageUrl: '/assets/categories/animation.png' },
  { id: 'anime', titles: { en: 'Anime', es: 'Anime', fr: 'Anime', de: 'Anime' }, icon: 'ph-shooting-star', parentId: 'animation', imageUrl: '/assets/categories/anime.png' },
  { id: 'gaming', titles: { en: 'Gaming', es: 'Videojuegos', fr: 'Jeux Vidéo', de: 'Gaming' }, icon: 'ph-game-controller', parentId: 'entertainment', imageUrl: '/assets/categories/gaming.png' },
  { id: 'rpg', titles: { en: 'RPG', es: 'RPG', fr: 'RPG', de: 'RPG' }, icon: 'ph-castle-turret', parentId: 'gaming', imageUrl: '/assets/categories/rpg.png' },
  { id: 'fps', titles: { en: 'FPS', es: 'FPS', fr: 'FPS', de: 'FPS' }, icon: 'ph-crosshair', parentId: 'gaming', imageUrl: '/assets/categories/fps.png' },
  { id: 'moba', titles: { en: 'MOBA', es: 'MOBA', fr: 'MOBA', de: 'MOBA' }, icon: 'ph-sword', parentId: 'gaming', imageUrl: '/assets/categories/moba.png' },
  { id: 'tech', titles: { en: 'Technology', es: 'Tecnología', fr: 'Technologie', de: 'Technologie' }, icon: 'ph-cpu', parentId: null, imageUrl: '/assets/categories/tech.png' },
  { id: 'ai', titles: { en: 'Artificial Intelligence', es: 'IA', fr: 'IA', de: 'KI' }, icon: 'ph-robot', parentId: 'tech', imageUrl: '/assets/categories/ai.png' },
  { id: 'genai', titles: { en: 'Generative AI', es: 'IA Generativa', fr: 'IA Générative', de: 'Generative KI' }, icon: 'ph-magic-wand', parentId: 'ai', imageUrl: '/assets/categories/genai.png' },
  { id: 'ml', titles: { en: 'Machine Learning', es: 'Aprendizaje Automático', fr: 'ML', de: 'ML' }, icon: 'ph-brain', parentId: 'ai', imageUrl: '/assets/categories/ml.png' },
  { id: 'robotics', titles: { en: 'Robotics', es: 'Robótica', fr: 'Robotique', de: 'Robotik' }, icon: 'ph-armchair', parentId: 'ai', imageUrl: '/assets/categories/robotics.png' },
  { id: 'dev', titles: { en: 'Development', es: 'Desarrollo', fr: 'Développement', de: 'Entwicklung' }, icon: 'ph-code', parentId: 'tech', imageUrl: '/assets/categories/dev.png' },
  { id: 'webdev', titles: { en: 'Web Dev', es: 'Desarrollo Web', fr: 'Dév Web', de: 'Webentwicklung' }, icon: 'ph-browser', parentId: 'dev', imageUrl: '/assets/categories/webdev.png' },
  { id: 'cybersec', titles: { en: 'Cybersecurity', es: 'Ciberseguridad', fr: 'Cybersécurité', de: 'Cybersicherheit' }, icon: 'ph-shield-checkered', parentId: 'tech', imageUrl: '/assets/categories/cybersec.png' },
  { id: 'hardware', titles: { en: 'Hardware', es: 'Hardware', fr: 'Hardware', de: 'Hardware' }, icon: 'ph-circuit-board', parentId: 'tech', imageUrl: '/assets/categories/hardware.png' },
  { id: 'gpus', titles: { en: 'GPUs', es: 'GPUs', fr: 'GPUs', de: 'GPUs' }, icon: 'ph-image', parentId: 'hardware', imageUrl: '/assets/categories/gpus.png' },
  ...
  { id: 'space', titles: { en: 'Space', es: 'Espacio', fr: 'Espace', de: 'Weltraum' }, icon: 'ph-planet', parentId: 'science', imageUrl: '/assets/categories/space.png' },
  { id: 'astronomy', titles: { en: 'Astronomy', es: 'Astronomía', fr: 'Astronomie', de: 'Astronomie' }, icon: 'ph-telescope', parentId: 'space', imageUrl: '/assets/categories/astronomy.png' },
  ...
  { id: 'quantum', titles: { en: 'Quantum Physics', es: 'Física Cuántica', fr: 'Physique Quantique', de: 'Quantenphysik' }, icon: 'ph-sparkle', parentId: 'physics', imageUrl: '/assets/categories/quantum.png' },
  { id: 'biology', titles: { en: 'Biology', es: 'Biología', fr: 'Biologie', de: 'Biologie' }, icon: 'ph-dna', parentId: 'science', imageUrl: '/assets/categories/biology.png' },
  { id: 'genetics', titles: { en: 'Genetics', es: 'Genética', fr: 'Génétique', de: 'Genetik' }, icon: 'ph-fingerprint', parentId: 'biology', imageUrl: '/assets/categories/genetics.png' },
  ...
  { id: 'football', titles: { en: 'Football', es: 'Fútbol', fr: 'Football', de: 'Fußball' }, icon: 'ph-soccer-ball', parentId: 'sports', imageUrl: '/assets/categories/football.png' },
  { id: 'basketball', titles: { en: 'Basketball', es: 'Baloncesto', fr: 'Basket', de: 'Basketball' }, icon: 'ph-basketball', parentId: 'sports', imageUrl: '/assets/categories/basketball.png' },
  ...
  { id: 'environment', titles: { en: 'Environment', es: 'Medio Ambiente', fr: 'Environnement', de: 'Umwelt' }, icon: 'ph-leaf', parentId: 'nature', imageUrl: '/assets/categories/environment.png' },
  { id: 'wildlife', titles: { en: 'Wildlife', es: 'Vida Silvestre', fr: 'Vie Sauvage', de: 'Wildtiere' }, icon: 'ph-paw-print', parentId: 'nature', imageUrl: '/assets/categories/wildlife.png' },
  { id: 'oceans', titles: { en: 'Oceans', es: 'Océanos', fr: 'Océans', de: 'Ozeane' }, icon: 'ph-waves', parentId: 'nature', imageUrl: '/assets/categories/oceans.png' },
